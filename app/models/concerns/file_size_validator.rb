class FileSizeValidator < ActiveModel::EachValidator
  MESSAGES  = { is: I18n.t('activerecord.errors.worker_profile.wrong_size'),
                minimum: I18n.t('activerecord.errors.worker_profile.size_too_small'),
                maximum: I18n.t('activerecord.errors.worker_profile.size_too_big') }.freeze
