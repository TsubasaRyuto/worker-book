class PastPerformanceDumplicateValidator < ActiveModel::EachValidator
  def validate_each(record, attribute, value)
    ...
    if record.past_performance3.blank? || record.past_performance4.blank?
      url_dumplicate6 = false
    else
      url_dumplicate6 = record.past_performance3 == record.past_performance4
    end
