      ...
      context 'successful' do
        before do
          ...
          if user.class == Worker
            ...
            patch :update, params: { id: user.reset_token, email: user.email, client: { password: 'foobaz123', password_confirmation: 'foobaz123' } }
          end
        end
        ...
        shared_examples_for 'invalid reset' do
          before do
            ...
            if user.class == Worker
              ...
              patch :update, params: { id: user.reset_token, email: user.email, client: { password: password, password_confirmation: confirmation } }
            end
          end
